...
public class EmpleadorController {
    ...
    //--check
    @DeleteMapping("/eliminarEntornodeTrabajo/{nombreEntorno}") //check
    ...
    @PostMapping("/agregarTarea/{nombreEmpleado}")//---check
    ...
    //CORREGIR ESTO-------------------------------
    @PutMapping("/editarTarea/{idTarea}/{nombreEmpleado}")
    ResponseEntity<Empleado> editarTarea(@RequestBody @Valid TareaDTO tarea, @PathVariable @NotNull @Min(1) Long idTarea, @PathVariable @NotBlank String nombreEmpleado) throws UsuarioNotFoundException, TareaNotFoundException {
        return new ResponseEntity<>(empleadorService.EditarTarea(tarea,idTarea, nombreEmpleado),HttpStatus.OK);
    }

    //----check
    @DeleteMapping("/eliminarTarea/{idTarea}/{nombreEmpleado}")
    void EliminarTarea(@PathVariable @NotNull @Min(1) Long idTarea, @PathVariable @NotBlank String nombreEmpleado) throws UsuarioNotFoundException, TareaNotFoundException{
